 ...
 * plus le fail-fast constructeur.
 */
class GatewaySecretFilterTest {
    ...
    void should_Return403_When_GatewaySecretHeaderIsAbsent() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/assessment/1");
    ...
    @Test
    void should_ThrowIllegalStateException_When_ExpectedSecretIsBlank() {
