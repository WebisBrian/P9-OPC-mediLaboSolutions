...
/**
 * Configuration Spring Security côté assessment-service.
 *
 ...
 *
 * Ce même JWT est ensuite relayé tel quel par PatientClient/NoteClient vers les
 * appels sortants (voir RelayedJwtProvider) : assessment ne détient aucune clé
 * privée et ne signe jamais de token lui-même.
 */
@Configuration
@EnableWebSecurity
